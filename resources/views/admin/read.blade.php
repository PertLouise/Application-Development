                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="email-leftbar card">
                                    ...
                                    <div class="mt-2">
                                        <a href="#" class="d-flex">
                                            <img class="me-3 rounded-circle" src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" alt="Generic placeholder image" height="36">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="me-3 rounded-circle" src="{{ asset('backend/assets/images/users/avatar-3.jpg') }}" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="me-3 rounded-circle" src="{{ asset('backend/assets/images/users/avatar-4.jpg') }}" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="me-3 rounded-circle" src="{{ asset('backend/assets/images/users/avatar-6.jpg') }}" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex mb-4">
                                                <img class="me-3 rounded-circle avatar-sm" src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" alt="Generic placeholder image">
                                                <div class="flex-1">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-2 col-6">
                                                    <div class="card">
                                                        <img class="card-img-top img-fluid" src="{{ asset('backend/assets/images/small/img-3.jpg') }}" alt="Card image cap">
                                                ...
                                                <div class="col-xl-2 col-6">
                                                    <div class="card">
                                                        <img class="card-img-top img-fluid" src="{{ asset('backend/assets/images/small/img-4.jpg') }}" alt="Card image cap">
                                                        <div class="py-2 text-center">
                                                            <a href="" class="fw-medium">Download</a>
                                                        </div>
                                                    </div>
