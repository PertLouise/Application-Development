                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="email-leftbar card">
                                    ...
                                    <div class="mt-2">
                                        <a href="#" class="d-flex">
                                            <img class="d-flex me-3 rounded-circle" src="{{ asset('backend/assets/images/users/avatar-2.jpg') }}" alt="Generic placeholder image" height="36">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="d-flex me-3 rounded-circle" src="{{ asset('backend/assets/images/users/avatar-3.jpg') }}" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="d-flex me-3 rounded-circle" src="{{ asset('backend/assets/images/users/avatar-4.jpg') }}" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="d-flex me-3 rounded-circle" src="{{ asset('backend/assets/images/users/avatar-6.jpg') }}" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
