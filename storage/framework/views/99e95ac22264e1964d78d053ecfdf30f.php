                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="<?php echo e(asset('backend/assets/images/logo-dark.png')); ?>" height="30" class="logo-dark mx-auto" alt="">
                                    <img src="<?php echo e(asset('backend/assets/images/logo-light.png')); ?>" height="30" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="p-3">
                            ...
                            <form class="form-horizontal mt-3" method="POST" action="<?php echo e(route('password.email')); ?>">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\rloui\app-name\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>