<?php $__env->startSection('admin'); ?>
 ...
 <div class="page-content">
    ...
    <a href="<?php echo e(route('admin.productadd')); ?>" class="btn btn-dark btn-rounded waves-effect waves-light" style="float:right;"><i class="fas fa-plus-circle"> Add Product </i></a> <br>  <br>               
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rloui\app-name\resources\views/admin/productall.blade.php ENDPATH**/ ?>