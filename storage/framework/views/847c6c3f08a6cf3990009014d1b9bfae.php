...
<html lang="en">
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <title>Read Email | InventoPro - Admin & Dashboard Template</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="email-leftbar card">
                                    ...
                                    <div class="mt-2">
                                        <a href="#" class="d-flex">
                                            <img class="me-3 rounded-circle" src="<?php echo e(asset('backend/assets/images/users/avatar-2.jpg')); ?>" alt="Generic placeholder image" height="36">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="me-3 rounded-circle" src="<?php echo e(asset('backend/assets/images/users/avatar-3.jpg')); ?>" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="me-3 rounded-circle" src="<?php echo e(asset('backend/assets/images/users/avatar-4.jpg')); ?>" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
                                        ...
                                        <a href="#" class="d-flex">
                                            <img class="me-3 rounded-circle" src="<?php echo e(asset('backend/assets/images/users/avatar-6.jpg')); ?>" alt="Generic placeholder image" height="36">
                                            <div class="flex-1 chat-user-box overflow-hidden">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="d-flex mb-4">
                                                <img class="me-3 rounded-circle avatar-sm" src="<?php echo e(asset('backend/assets/images/users/avatar-2.jpg')); ?>" alt="Generic placeholder image">
                                                <div class="flex-1">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-2 col-6">
                                                    <div class="card">
                                                        <img class="card-img-top img-fluid" src="<?php echo e(asset('backend/assets/images/small/img-3.jpg')); ?>" alt="Card image cap">
                                                ...
                                                <div class="col-xl-2 col-6">
                                                    <div class="card">
                                                        <img class="card-img-top img-fluid" src="<?php echo e(asset('backend/assets/images/small/img-4.jpg')); ?>" alt="Card image cap">
                                                        <div class="py-2 text-center">
                                                            <a href="" class="fw-medium">Download</a>
                                                        </div>
                                                    </div>
...
<?php echo $__env->make('admin.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\rloui\app-name\resources\views/admin/read.blade.php ENDPATH**/ ?>